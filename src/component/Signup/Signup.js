                ...
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    <form onSubmit={handlesignup} className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <input name="image" type="text" placeholder="photoURL" className="input input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                    ...
                    <p className='text-center my-5'>Alreay have any account? <Link className="label-text-alt link link-hover text-orange-600 font-bold py-10 " to='/login'>Login</Link></p>
                </div>
            </div>
        </div>
    );
